...
def test_elk_variant_position_pins() -> None:
    ...
    edge_index, node_sizes = _diamond_inputs()
    expected = {
        "UP": [[64.0542984, 200.0], [12.0, 106.0], [116.1085968, 106.0], [64.0542984, 12.0]],
        "RIGHT": [[12.0, 64.0542984], [106.0, 12.0], [106.0, 116.1085968], [200.0, 64.0542984]],
        "spacing": [[44.0542984, 12.0], [12.0, 126.0], [76.1085968, 126.0], [44.0542984, 240.0]],
