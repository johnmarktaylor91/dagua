...
# ---------------------------------------------------------------------------
# MultilevelVCycle -- V-cycle orchestrator skeleton
# ---------------------------------------------------------------------------
...
class MultilevelVCycle(Op):
    ...
    def __init__(
        ...
        """Store V-cycle hook pipelines and thresholds.
    ...
    def build_hierarchy(
        ...
        -------
        SolveState
            State with ``hierarchy`` populated.
    ...
    def solve_coarsest(
        ...
        -------
        SolveState
            State with coarsest-level positions.
    ...
    def prolong_and_refine(
        ...
        -------
        SolveState
            State with refined positions at this level.
