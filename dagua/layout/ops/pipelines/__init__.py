...
PIPELINE_REGISTRY: dict[str, PipelineSpec] = {
    ...
    "backbone": ("dagua.layout.ops.pipelines.backbone", "layout_backbone_pipeline"),
    ...
    "elk_layered_bk": ("dagua.layout.ops.pipelines.elk", "layout_elk_layered_bk_pipeline"),
    "elk_layered_ns": ("dagua.layout.ops.pipelines.elk", "layout_elk_layered_ns_pipeline"),
    ...
    "isom": ("dagua.layout.ops.pipelines.isom", "layout_isom_pipeline"),
