...
VARIANT_REGISTRY: list[AlgorithmVariant] = [
    ...
    _variant(
        ...
        "classic_stress_sgd",
        "Stress-SGD (steps=30)",
        {"steps": 30, "eps": 0.01, "fidelity_mode": True},
        "sgd2",
        {"t_max": 30, "eps": 0.01},
        True,
        True,
    ...
    _variant(
        ...
        {"steps": 300, "eps": 0.01, "fidelity_mode": True},
        "sgd2",
        {"t_max": 300, "eps": 0.01},
        True,
        True,
    ...
    _variant(
        ...
        {"steps": 300, "eps": 0.001, "fidelity_mode": True},
        "sgd2",
        {"t_max": 300, "eps": 0.001},
        True,
        True,
    ...
    _variant(
        ...
        "classic_stress_sgd",
        "Stress-SGD (eps=0.1)",
        {"steps": 300, "eps": 0.1, "fidelity_mode": True},
        "sgd2",
        {"t_max": 300, "eps": 0.1},
        True,
        True,
    ...
    _variant(
        ...
        {"networkx_fidelity": True, "fidelity_mode": "networkx"},
        "nx_spectral",
        {},
        True,
        False,
    ...
    _variant(
        ...
        {"dim": 2, "normalization": "random_walk", "scale": 1.0},
        True,
        False,
        True,
    ),
    ...
    _variant(
        "classic_classical_mds_igraph_fidelity",
        "classic_classical_mds",
        "Classical MDS (igraph fidelity)",
    ...
    _variant(
        ...
        {"iterations": 200, "fidelity_mode": "ogdf"},
        "ogdf_stress",
        {"iterations": 200},
        False,
        True,
    ...
    _variant(
        "classic_neato",
        "classic_neato",
        "Graphviz neato fidelity",
        {"maxiter": 200, "epsilon": 0.0001, "pack": True, "fidelity_mode": "graphviz"},
        "graphviz_neato",
        {"maxiter": 200, "epsilon": 0.0001, "pack": True},
        True,
        True,
        True,
    ),
    ...
    _variant(
        ...
        {"iterations": 50, "fidelity_mode": "ogdf"},
        "ogdf_stress",
        {"iterations": 50},
        False,
        True,
    ...
    _variant(
        ...
        {"iterations": 500, "fidelity_mode": "ogdf"},
        "ogdf_stress",
        {"iterations": 500},
        False,
        True,
    ...
    _variant(
        ...
        "classic_sugiyama",
        "Sugiyama (default)",
        {"barycenter_passes": 24, "rank_sep": 1.0, "node_sep": 1.0, "fidelity_mode": "igraph"},
        "igraph_sugiyama",
    ...
    _variant(
        ...
        "classic_sugiyama",
        "Sugiyama (passes=4)",
        {"barycenter_passes": 4, "rank_sep": 1.0, "node_sep": 1.0, "fidelity_mode": "igraph"},
        "igraph_sugiyama",
    ...
    _variant(
        ...
        "classic_sugiyama",
        "Sugiyama (passes=48)",
        {"barycenter_passes": 48, "rank_sep": 1.0, "node_sep": 1.0, "fidelity_mode": "igraph"},
        "igraph_sugiyama",
    ...
    _variant(
        ...
        "classic_sugiyama",
        "Sugiyama (wide)",
        {"barycenter_passes": 24, "rank_sep": 2.0, "node_sep": 2.0, "fidelity_mode": "igraph"},
        "igraph_sugiyama",
    ...
    _variant(
        ...
        "classic_sugiyama",
        "Sugiyama (tight)",
        {"barycenter_passes": 24, "rank_sep": 0.5, "node_sep": 0.5, "fidelity_mode": "igraph"},
        "igraph_sugiyama",
    ...
    _variant(
        ...
        "classic_tsnet",
        "tsNET (default)",
        {"perplexity": 30.0, "steps": 500, "fidelity_mode": True},
        "tsne_graph",
    ...
    _variant(
        ...
        "classic_tsnet",
        "tsNET (perplexity=5)",
        {"perplexity": 5.0, "steps": 500, "fidelity_mode": True},
        "tsne_graph",
    ...
    _variant(
        ...
        "classic_tsnet",
        "tsNET (perplexity=50)",
        {"perplexity": 50.0, "steps": 500, "fidelity_mode": True},
        "tsne_graph",
    ...
    _variant(
        ...
        {"perplexity": 30.0, "steps": 250, "fidelity_mode": True},
        "tsne_graph",
    ...
    _variant(
        ...
        "classic_tsnet",
        "tsNET (steps=2000)",
        {"perplexity": 30.0, "steps": 2000, "fidelity_mode": True},
        "tsne_graph",
    ...
    _variant(
        ...
        "classic_gem",
        "GEM (iters=100)",
        {"max_iters": 100, "fidelity_mode": "ogdf"},
        "ogdf_gem",
        {"rounds": 100},
        False,
        True,
    ...
    _variant(
        ...
        "classic_gem",
        "GEM (iters=500)",
        {"max_iters": 500, "fidelity_mode": "ogdf"},
        "ogdf_gem",
        {"rounds": 500},
        False,
        True,
    ...
    _variant(
        ...
        "classic_gem",
        "GEM (iters=2000)",
        {"max_iters": 2000, "fidelity_mode": "ogdf"},
        "ogdf_gem",
        {"rounds": 2000},
        False,
        True,
    ...
    _variant(
        ...
        "classic_linlog",
        "LinLog (default)",
        {"a": 1.0, "r": 0.0, "steps": 300, "fidelity_mode": True},
        "linlog",
        {"attrExponent": 1.0, "repuExponent": 0.0, "steps": 300},
        True,
        True,
        False,
    ),
    _variant(
        ...
        "classic_linlog",
        "LinLog (a=2.0)",
        {"a": 2.0, "r": 0.0, "steps": 300, "fidelity_mode": True},
        "linlog",
        {"attrExponent": 2.0, "repuExponent": 0.0, "steps": 300},
        True,
        True,
        False,
    ),
    _variant(
        ...
        "classic_linlog",
        "LinLog (r=0.5)",
        {"a": 1.0, "r": 0.5, "steps": 300, "fidelity_mode": True},
        "linlog",
        {"attrExponent": 1.0, "repuExponent": 0.5, "steps": 300},
        True,
        True,
        False,
    ),
    _variant(
        ...
        "classic_linlog",
        "LinLog (steps=100)",
        {"a": 1.0, "r": 0.0, "steps": 100, "fidelity_mode": True},
        "linlog",
        {"attrExponent": 1.0, "repuExponent": 0.0, "steps": 100},
        True,
        True,
        False,
    ),
    _variant(
        ...
        "classic_linlog",
        "LinLog (steps=500)",
        {"a": 1.0, "r": 0.0, "steps": 500, "fidelity_mode": True},
        "linlog",
        {"attrExponent": 1.0, "repuExponent": 0.0, "steps": 500},
        True,
        True,
        False,
    ),
    ...
    _variant(
        ...
        {"horizontal": True, "fidelity_mode": "igraph"},
        "igraph_rt_horizontal",
        {"horizontal": True, "mode": "out"},
        True,
        False,
        False,
    ),
    ...
    _variant(
        ...
        "classic_drl",
        "DrL (default)",
        {"options": "default", "fidelity_mode": True},
        "igraph_drl",
        {"options": "default"},
        True,
        True,
    ...
    _variant(
        ...
        "classic_drl",
        "DrL (coarsen)",
        {"options": "coarsen", "fidelity_mode": True},
        "igraph_drl",
        {"options": "coarsen"},
        True,
        True,
    ...
    _variant(
        ...
        "classic_drl",
        "DrL (coarsest)",
        {"options": "coarsest", "fidelity_mode": True},
        "igraph_drl",
        {"options": "coarsest"},
        True,
        True,
    ...
    _variant(
        ...
        "classic_drl",
        "DrL (refine)",
        {"options": "refine", "fidelity_mode": True},
        "igraph_drl",
        {"options": "refine"},
        True,
        True,
    ...
    _variant(
        ...
        "classic_drl",
        "DrL (final)",
        {"options": "final", "fidelity_mode": True},
        "igraph_drl",
        {"options": "final"},
        True,
        True,
    ...
    _variant(
        ...
        "classic_lgl",
        "LGL (default)",
        {"maxiter": 150, "coolexp": 1.5, "fidelity_mode": True},
        "igraph_lgl",
    ...
    _variant(
        ...
        "classic_lgl",
        "LGL (iters=50)",
        {"maxiter": 50, "coolexp": 1.5, "fidelity_mode": True},
        "igraph_lgl",
    ...
    _variant(
        ...
        "classic_lgl",
        "LGL (iters=300)",
        {"maxiter": 300, "coolexp": 1.5, "fidelity_mode": True},
        "igraph_lgl",
    ...
    _variant(
        ...
        "classic_lgl",
        "LGL (cool=1.0)",
        {"maxiter": 150, "coolexp": 1.0, "fidelity_mode": True},
        "igraph_lgl",
    ...
    _variant(
        ...
        "classic_lgl",
        "LGL (cool=2.0)",
        {"maxiter": 150, "coolexp": 2.0, "fidelity_mode": True},
        "igraph_lgl",
    ...
    _variant(
        ...
        "classic_sfdp",
        "SFDP (theta=0.4)",
        {"steps": 500, "theta": 0.4, "repulsive_exponent": -1.0, "fidelity_mode": "graphviz"},
        "graphviz_sfdp",
        {"maxiter": 500, "theta": 0.4, "repulsiveforce": -1.0},
        False,
        True,
        False,
    ...
    _variant(
        ...
        "classic_sfdp",
        "SFDP (theta=0.8)",
        {"steps": 500, "theta": 0.8, "repulsive_exponent": -1.0, "fidelity_mode": "graphviz"},
        "graphviz_sfdp",
        {"maxiter": 500, "theta": 0.8, "repulsiveforce": -1.0},
        False,
        True,
        False,
        reference_expressible=False,
    ...
    _variant(
        ...
        "classic_sfdp",
        "SFDP (steps=200)",
        {"steps": 200, "theta": 0.6, "repulsive_exponent": -1.0, "fidelity_mode": "graphviz"},
        "graphviz_sfdp",
        {"maxiter": 200, "theta": 0.6, "repulsiveforce": -1.0},
        False,
        True,
        False,
        reference_expressible=False,
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (default)",
        {"n_neighbors": 15, "min_dist": 0.1, "spread": 1.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (neighbors=5)",
        {"n_neighbors": 5, "min_dist": 0.1, "spread": 1.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (neighbors=30)",
        {"n_neighbors": 30, "min_dist": 0.1, "spread": 1.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (min_dist=0.01)",
        {"n_neighbors": 15, "min_dist": 0.01, "spread": 1.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (min_dist=0.5)",
        {"n_neighbors": 15, "min_dist": 0.5, "spread": 1.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_umap",
        "UMAP (spread=2.0)",
        {"n_neighbors": 15, "min_dist": 0.1, "spread": 2.0, "fidelity_mode": True},
        "umap_graph",
    ...
    _variant(
        ...
        "classic_neulay",
        "NeuLay (no GCN)",
        {"steps": 20000, "use_gcn": False, "lr": 0.1, "radius": 0.4, "fidelity_mode": "old_code"},
        "neulay",
    ...
    _variant(
        ...
        "cytoscape_fcose",
        {"quality": "default", "randomize": True, "numIter": 2500},
        True,
        True,
        False,
    ),
    _variant(
        ...
        "cytoscape_fcose",
        {"quality": "proof", "randomize": True, "numIter": 2500},
        True,
        True,
        True,
    ),
...
VARIANT_REGISTRY.extend(
    [
        _variant(
            "dagre_reimpl_default",
            "dagre_reimpl",
            "Dagre",
            {},
            "dagre",
        ...
        _variant(
            "d3_tree_reimpl_default",
            "d3_tree_reimpl",
            "d3 tree",
            {},
            "d3hierarchy",
            {"algorithm": "tree", "node_size": True, "radial": False},
            True,
            False,
            False,
        ),
        _variant(
            "d3_tree_radial_reimpl_default",
            "d3_tree_radial_reimpl",
            "d3 radial tree",
            {},
            "d3hierarchy",
            {"algorithm": "tree", "node_size": True, "radial": True},
            True,
            False,
            False,
        ),
        _variant(
            "d3_cluster_reimpl_default",
            "d3_cluster_reimpl",
            "d3 cluster",
            {},
            "d3hierarchy",
            {"algorithm": "cluster", "node_size": False, "radial": False},
            True,
            False,
            False,
        ),
        _variant(
            "d3_cluster_radial_reimpl_default",
            "d3_cluster_radial_reimpl",
            "d3 radial cluster",
            {},
            "d3hierarchy",
            {"algorithm": "cluster", "node_size": False, "radial": True},
            True,
            False,
            False,
        ),
        _variant(
            "circo_reimpl_default",
            "circo_reimpl",
            "Graphviz circo",
            {},
            "graphviz_circo",
        ...
        _variant(
            "nx_multipartite_reimpl_default",
            "nx_multipartite_reimpl",
            "NetworkX multipartite",
            {},
            "nx_multipartite",
            {},
            True,
        ...
        _variant(
            "nx_bfs_reimpl_default",
            "nx_bfs_reimpl",
            "NetworkX BFS multipartite",
            {},
            "nx_bfs",
            {},
            True,
        ...
        _variant(
            "backbone_reimpl_default",
            "backbone_reimpl",
            "graphlayouts backbone",
            {},
            "backbone",
            {"keep": 0.2},
            True,
        ...
        _variant(
            "smacof_nonmetric_reimpl_default",
            "smacof_nonmetric_reimpl",
            "sklearn nonmetric SMACOF",
            {},
...
_BASE_ENGINE_STOCHASTICITY: dict[str, bool] = {
    ...
    "dagre_reimpl": False,
    "dagre": False,
    "elk_layered_reimpl": False,
    "elk_layered": False,
    "elk_force_reimpl": True,
    "elk_force": True,
    "elk_stress_reimpl": True,
    "elk_stress": True,
    "elk_mrtree_reimpl": False,
    "elk_mrtree": False,
    "elk_radial_reimpl": False,
    "elk_radial": False,
    "d3force_reimpl": True,
    "d3force": True,
    "d3_tree_reimpl": False,
    "d3_tree_radial_reimpl": False,
    "d3_cluster_reimpl": False,
    "d3_cluster_radial_reimpl": False,
    "d3hierarchy": False,
    "circo_reimpl": False,
    "twopi_reimpl": False,
    "osage_reimpl": False,
    "graphviz_circo": False,
    "graphviz_twopi": False,
    "graphviz_osage": False,
    "ogdf_balloon_reimpl": False,
    "ogdf_bertault_reimpl": False,
    "ogdf_fpp_reimpl": False,
    "ogdf_schnyder_reimpl": False,
    "ogdf_sugiyama_reimpl": False,
    "ogdf_balloon": False,
    "ogdf_bertault": False,
    "ogdf_fpp": False,
    "ogdf_schnyder": False,
    "ogdf_sugiyama": False,
    "nx_circular_reimpl": False,
    "nx_shell_reimpl": False,
    "nx_spiral_reimpl": False,
    "nx_bipartite_reimpl": False,
    "nx_multipartite_reimpl": False,
    "nx_bfs_reimpl": False,
    "nx_planar_reimpl": False,
    "nx_arf_reimpl": True,
    "nx_circular": False,
    "nx_shell": False,
    "nx_spiral": False,
    "nx_bipartite": False,
    "nx_multipartite": False,
    "nx_bfs": False,
    "nx_planar": False,
    "nx_arf": True,
    "backbone_reimpl": True,
    "backbone": True,
    "sparse_stress_reimpl": True,
    "sparse_stress": True,
    "isom_reimpl": True,
    "isom_jung": True,
    "smacof_nonmetric_reimpl": True,
    "sklearn_smacof_nonmetric": True,
    "coregd_reimpl": False,
    "coregd_reference": False,
    "smartgd_reimpl": False,
    "smartgd_reference": False,
    "deepgd_reimpl": False,
    "deepgd_reference": False,
    "tfdp_reimpl": True,
    "tfdp": True,
    "pacmap_reimpl": True,
    "pacmap": True,
    "word2vecgd_reimpl": True,
    "word2vecgd": True,
    "drgraph_reimpl": True,
    "drgraph_reference": True,
    "largevis_reimpl": True,
    "largevis_reference": True,
    "mulment_reimpl": True,
    "mulment_reference": True,
    "nnpnet_reimpl": True,
...
_BASE_ENGINE_HEAVY: dict[str, bool] = {
    ...
    "sklearn_smacof_nonmetric": True,
    "coregd_reimpl": True,
    "coregd_reference": True,
    "smartgd_reimpl": True,
    "smartgd_reference": True,
    "deepgd_reimpl": True,
    "deepgd_reference": True,
    "tfdp_reimpl": True,
    "tfdp": True,
    "pacmap_reimpl": True,
    "pacmap": True,
