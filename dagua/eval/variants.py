...
VARIANT_REGISTRY: list[AlgorithmVariant] = [
    ...
    _variant(
        ...
        "classic_neulay",
        "NeuLay (no GCN)",
        {"steps": 20000, "gcn_steps": 2000, "use_gcn": False, "lr": 0.1, "radius": 0.4},
        "neulay",
        {"steps": 20000, "gcn_steps": 2000, "use_gcn": False, "lr": 0.1, "radius": 0.4},
        True,
        True,
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (default)",
        {"criteria": {"stress": 1.0, "ideal_edge_length": 1.0}, "lr": 0.01},
        "sgd2_multi_ref",
        {
    ...
    _variant(
        ...
        {"criteria": {"stress": 1.0, "crossings": 0.5}, "lr": 0.01},
        "sgd2_multi_ref",
        {
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (with aspect)",
        {"criteria": {"stress": 0.8, "aspect_ratio": 0.2}, "lr": 0.01},
        "sgd2_multi_ref",
        {
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (lr=0.001)",
        {"criteria": {"stress": 1.0, "ideal_edge_length": 1.0}, "lr": 0.001},
        "sgd2_multi_ref",
        {
            "criteria_weights": {"stress": 1.0, "ideal_edge_length": 1.0},
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (lr=0.1)",
        {"criteria": {"stress": 1.0, "ideal_edge_length": 1.0}, "lr": 0.1},
        "sgd2_multi_ref",
        {
            "criteria_weights": {"stress": 1.0, "ideal_edge_length": 1.0},
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (batch=8)",
        {"criteria": {"stress": 1.0, "ideal_edge_length": 1.0}, "lr": 0.01, "batch_size": 8},
        "sgd2_multi_ref",
        {
            "criteria_weights": {"stress": 1.0, "ideal_edge_length": 1.0},
            "optimizer_kwargs": {"lr": 0.01},
    ...
    _variant(
        ...
        "classic_sgd2_multi",
        "(SGD)^2 (batch=128)",
        {"criteria": {"stress": 1.0, "ideal_edge_length": 1.0}, "lr": 0.01, "batch_size": 128},
        "sgd2_multi_ref",
        {
            "criteria_weights": {"stress": 1.0, "ideal_edge_length": 1.0},
            "optimizer_kwargs": {"lr": 0.01},
