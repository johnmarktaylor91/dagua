...
GRAPHVIZ_STRICT_THEME = Theme(
    ...
    cluster_style=ClusterStyle(
        ...
        stroke="#AAAAAA",  # light gray hairline like Graphviz cluster borders
...
# Cog sci box-and-arrow -- classic cognitive architecture diagrams:
...
# Speech bubbles -- comic/dialogue: rounded cloud shapes, bright
...
SPEECH_BUBBLE_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#F0F8FF"),
)
...
TRADE_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#F5F0E0"),
)
...
ASSEMBLY_LINE_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#ECEFF1"),
)
FOREST_PATH_THEME = Theme(
    ...
    edge_styles={
        "default": EdgeStyle(
            color="#8B6D44", width=2.0, style="solid", arrow="none", routing="bezier", curvature=0.3
        ),
        "back": EdgeStyle(
            color="#A08860",
            width=1.0,
...
HOPFIELD_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#1A1A2A"),
)
...
PLAYING_CARDS_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#2E7D32"),
)
...
CASINO_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#0D2818"),
)
...
DANTE_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#100810"),
)
ABACUS_THEME = Theme(
    name="abacus",
    category="whimsy",
    ...
    graph_style=GraphStyle(background_color="#D8C098"),
)
PENDULUM_THEME = Theme(
    ...
    edge_styles={
        ...
        "back": EdgeStyle(
            color="#6A6A7A", width=0.5, style="solid", arrow="none", routing="bezier", curvature=0.2
        ),
    },
    cluster_style=ClusterStyle(
        fill="#2A2A3A",
    ...
    graph_style=GraphStyle(background_color="#2A2A3A"),
)
...
TERRARIUM_THEME = Theme(
    ...
    graph_style=GraphStyle(background_color="#D0E8D0"),
)
BONSAI_THEME = Theme(
    name="bonsai",
    category="nature",
    ...
    edge_styles={
        "default": EdgeStyle(
            color="#6B4C33", width=1.5, style="solid", arrow="none", routing="bezier", curvature=0.3
        ),
        "back": EdgeStyle(
            color="#8B6D44", width=0.8, style="solid", arrow="none", routing="bezier", curvature=0.4
        ),
    },
    cluster_style=ClusterStyle(
        fill="#E0D8C0",
    ...
    graph_style=GraphStyle(background_color="#E0D8C0"),
)
...
THEME_REGISTRY["abacus"] = ABACUS_THEME
THEME_REGISTRY["pendulum"] = PENDULUM_THEME
THEME_REGISTRY["dominos_falling"] = DOMINOS_FALLING_THEME
THEME_REGISTRY["terrarium"] = TERRARIUM_THEME
THEME_REGISTRY["bonsai"] = BONSAI_THEME
THEME_REGISTRY["casino"] = CASINO_THEME
THEME_REGISTRY["hopfield"] = HOPFIELD_THEME
THEME_REGISTRY["neuromorphic"] = NEUROMORPHIC_THEME
THEME_REGISTRY["connect_dots"] = CONNECT_DOTS_THEME
THEME_REGISTRY["playing_cards"] = PLAYING_CARDS_THEME
...
BEADS_THEME = Theme(
    ...
    edge_styles={
        ...
        "back": EdgeStyle(
            color="#D8C8A8", width=0.6, style="solid", arrow="none", routing="bezier", curvature=0.2
        ),
    },
    cluster_style=ClusterStyle(
        fill="#F8F0E8",
...
THEME_REGISTRY["pachinko"] = PACHINKO_THEME
THEME_REGISTRY["beads"] = BEADS_THEME
THEME_REGISTRY["assembly_line"] = ASSEMBLY_LINE_THEME
THEME_REGISTRY["forest_path"] = FOREST_PATH_THEME
THEME_REGISTRY["trade"] = TRADE_THEME
THEME_REGISTRY["engineering"] = ENGINEERING_THEME
THEME_REGISTRY["cog_sci"] = COG_SCI_THEME
THEME_REGISTRY["speech_bubble"] = SPEECH_BUBBLE_THEME
...
# dbt -- data build tool: orange brand color, data lineage DAGs,
# SQL model nodes, source/test differentiation, modern data stack
DBT_THEME = Theme(
    name="dbt",
    category="tools",
    node_styles={
        ...
        "input": NodeStyle(
            shape="roundrect",
            fill="#FF694B",  # dbt orange -- source node
            stroke="#E04E30",
            stroke_width=1.2,
            font_family="Inter",
            font_size=8.5,
        ...
        "output": NodeStyle(
            shape="roundrect",
            fill="#F5F5F5",  # light gray -- test/exposure
            stroke="#CCCCCC",
            stroke_width=0.6,
            font_family="Inter",
            font_size=7.5,
...
# Prefect -- modern Python orchestrator: dark navy background, cyan
# accent, flow/task nodes, sleek developer aesthetic
PREFECT_THEME = Theme(
    name="prefect",
    category="tools",
    node_styles={
        "default": NodeStyle(
            shape="roundrect",
            fill="#1A2744",  # dark navy card
            stroke="#00C2FF",  # Prefect cyan
            stroke_width=0.8,
            font_family="Inter",
            font_size=8.0,
            font_color="#E0E8F0",
    ...
    graph_style=GraphStyle(background_color="#0B1329"),
)

# Terraform -- infrastructure as code: HashiCorp purple, resource
# dependency graphs, provider/module/resource node types
TERRAFORM_THEME = Theme(
    name="terraform",
    category="tools",
    node_styles={
        "default": NodeStyle(
            shape="roundrect",
            fill="#FFFFFF",
            stroke="#7B42BC",  # Terraform purple
            stroke_width=0.9,
            font_family="Helvetica",
            font_size=8.0,
            font_color="#333333",
        ...
        "input": NodeStyle(
            shape="roundrect",
            fill="#7B42BC",  # purple -- provider/data source
            stroke="#5C2D91",
            stroke_width=1.2,
            font_family="Helvetica",
            font_size=8.5,
...
# GitHub Actions -- CI/CD workflows: GitHub dark theme, green success,
# blue action nodes, job/step DAG structure
GITHUB_ACTIONS_THEME = Theme(
    name="github_actions",
    category="tools",
    node_styles={
        "default": NodeStyle(
            shape="roundrect",
            fill="#161B22",  # GitHub dark surface
            stroke="#30363D",
            stroke_width=0.8,
            font_family="Helvetica",
            font_size=8.0,
        ...
        "input": NodeStyle(
            shape="roundrect",
            fill="#2EA043",  # GitHub green -- trigger/start
            stroke="#238636",
            stroke_width=1.0,
            font_family="Helvetica",
            font_size=8.5,
    ...
    graph_style=GraphStyle(background_color="#0D1117"),
)

# AWS Step Functions -- serverless state machines: AWS orange on dark
# navy, state/task/choice nodes, orchestration flow
STEP_FUNCTIONS_THEME = Theme(
    name="step_functions",
    category="tools",
    node_styles={
        "default": NodeStyle(
        ...
        "input": NodeStyle(
            shape="roundrect",
            fill="#FF9900",  # AWS orange -- start state
            stroke="#E88B00",
            stroke_width=1.0,
            font_family="Helvetica",
            font_size=8.5,
    ...
    graph_style=GraphStyle(background_color="#232F3E"),
)

# Argo Workflows -- Kubernetes-native workflow engine: Argo orange,
# container/step/DAG task nodes, clean white background
ARGO_THEME = Theme(
    name="argo",
    category="tools",
    node_styles={
...
# Kubernetes -- container orchestration: K8s blue, pod/service/deployment
# nodes, namespace clusters, infrastructure dependency graphs
KUBERNETES_THEME = Theme(
    name="kubernetes",
    category="tools",
    node_styles={
        "default": NodeStyle(
...
# Zapier -- automation platform: Zapier orange, trigger/action nodes,
# clean white background, simple linear flows
ZAPIER_THEME = Theme(
    name="zapier",
    category="tools",
    node_styles={
...
THEME_REGISTRY["dbt"] = DBT_THEME
THEME_REGISTRY["prefect"] = PREFECT_THEME
THEME_REGISTRY["terraform"] = TERRAFORM_THEME
THEME_REGISTRY["github_actions"] = GITHUB_ACTIONS_THEME
THEME_REGISTRY["step_functions"] = STEP_FUNCTIONS_THEME
THEME_REGISTRY["argo"] = ARGO_THEME
