...
Result: **4/11 similarity-exact**, **1 positional-identical**, **6 divergent**. Thresholds: bit-exact `d_R < 1e-09`, positional `d_R < 1e-03`.

| graph | N | E | Procrustes d_R | anisotropic d_R | max raw diff | verdict | first divergent stage |
|---|---:|---:|---:|---:|---:|---|---|
| single_node | 1 | 0 | 0.000e+00 | 0.000e+00 | 3.800e+01 | bit-exact | none |
| small_chain | 6 | 5 | 0.000e+00 | 6.536e-17 | 6.825e+02 | bit-exact | none |
| binary_tree | 11 | 10 | 5.813e-01 | 5.562e-01 | 1.072e+03 | divergent | block-tree coordinate placement after owned block discovery |
| diamond | 4 | 4 | 1.357e-16 | 9.956e-17 | 2.052e+02 | bit-exact | none |
| grid_5x5 | 25 | 40 | 1.082e+00 | 9.101e-01 | 1.112e+03 | divergent | block-tree coordinate placement after owned block discovery |
| org_chart_small | 16 | 15 | 4.571e-01 | 4.349e-01 | 9.377e+02 | divergent | block-tree coordinate placement after owned block discovery |
| long_skip | 5 | 6 | 1.370e-05 | 1.111e-05 | 2.445e+02 | positional-identical | none |
| disconnected | 5 | 2 | 1.095e+00 | 9.163e-01 | 1.990e+02 | divergent | component packing plus block-tree coordinate placement |
| cycle_4 | 4 | 4 | 1.344e-16 | 9.778e-17 | 1.998e+02 | bit-exact | none |
| random_dag_50 | 50 | 90 | 1.100e+00 | 9.109e-01 | 2.474e+03 | divergent | block-tree coordinate placement after owned block discovery |
| org_chart_deep | 79 | 78 | 6.452e-01 | 6.010e-01 | 7.186e+03 | divergent | block-tree coordinate placement after owned block discovery |
...
The current circo implementation uses Graphviz-style owned block-cutpoint discovery and records block order metadata. Simple paths, simple cycles, and the long-skip case are positional-or-better; remaining circo residuals first diverge in the recursive block-tree coordinate placement/rotation stage, with disconnected also requiring Graphviz component packing.
